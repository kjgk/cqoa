...
angular.module('base', ['restangular', 'ui.bootstrap', 'ui.router', 'validation', 'validation.rule', 'angular-loading-bar'])

    .value('PageContext', PageContext)

    .config(function (cfpLoadingBarProvider, RestangularProvider) {
