		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Yahoo! Weather Error') {
					...
					// Add item data
					html += '<div class="weatherCity">'+ options.city +'</div>';
					if (options.country) html += '<div class="weatherCountry">'+ feed.location.country +'</div>';
					html += '<div class="weatherTemp">'+ feed.item.condition.temp +'&deg;</div>';
					html += '<div class="weatherDesc">'+ weatherDetail[feed.item.condition.code] +'</div>';
				
					// Add optional data
					if (options.highlow) html += '<div class="weatherRange">最高温: '+ wf.high +'&deg;</div>';
					if (options.highlow) html += '<div class="weatherRange">最低温: '+ wf.low +'&deg;</div>';
