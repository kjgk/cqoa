...
TToolBox.prototype.mouseMove = function () {
    switch (this.moveType) {
        case"m":
            this.Left = event.clientX - this.CurrentX;
...
TToolBox.prototype.toString = function () {
    var S = '<table id="' + this.ID + '" class="toolbox" style="position:absolute;left:' + this.Left + 'px;top:' + this.Top + 'px;width:' +
